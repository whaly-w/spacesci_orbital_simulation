...
class Planet():
    ...
    def __init__(self, name, x, y, radius, color, mass, orbital_velocity= 0, img= None, shift_factor= (1, 1), scale_factor= 1, isSun= False):
        self.name = name
        self.x = x
        self.y = y
        self.raduis = radius
        ...
        if img is not None:
            self.img = pygame.transform.scale(pygame.image.load(img).convert_alpha(), (radius *2, radius *2))
